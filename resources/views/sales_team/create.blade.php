...
@section('content')
    ...
    <div class="row g-5">
        <div class="col-md-7 col-lg-8">
            <form method="post" action="{{ route('sales_team.store') }}" class="needs-validation" novalidate>
                {{ csrf_field() }}
                <div class="row g-3">
                    <div class="col-md-8">
                        @if(count($errors) > 0)
                    ...
                    <div class="col-12">
                        ...
                        <x-text-field name="person_name" :type="'text'" :id="'person_name'" :placeholder="'Full Name'" value="{{ old('person_name') }}"></x-text-field>
                    ...
                    <div class="col-12">
                        ...
                        <x-text-field name="email" :type="'text'" :id="'email'" :placeholder="'Email Address'" value="{{ old('email') }}"></x-text-field>
                        @if($errors->has('email'))
                    ...
                    <div class="col-12">
                        ...
                        <x-text-field name="telephone" :type="'text'" :id="'telephone'" :placeholder="'Telephone'" value="{{ old('telephone') }}"></x-text-field>
                    ...
                    <div class="col-md-6">
                        ...
                        <x-date-picker name="joined_date" :id="'joined_date'" value="{{ old('joined_date') }}" value="{{ old('joined_date') }}"></x-date-picker>
                    ...
                    <div class="col-md-6">
                        ...
                        <x-selection name="current_route" :placeholder="'Select a current route'" :id="'current_route'" value="{{ old('current_route') }}">
                            <option value="">Choose...</option>
                            @if(!empty($currentRoutes))
                                @foreach($currentRoutes as $currentRoute)
                                    <option value="{{ $currentRoute->id }}">{{ $currentRoute->route_name }}</option>
                                @endforeach
                            @endif
                        </x-selection>
                ...
                <x-secondary-button :class-name="'primary btn-lg w-100'" :type="'submit'">Save sales team details</x-secondary-button>
            </form>
        </div>
    </div>
@stop
